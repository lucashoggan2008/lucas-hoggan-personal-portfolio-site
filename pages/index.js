...
const MainPage = () => {
  return (
    <main>
      <Seperator />
      <PhoneWebComponent PhoneComponent={<Image alt="about me"   width={0} height={0} className="w-screen" src="/intro-code-banner.svg" />} WebComponent={<Image alt="about me"   width={0} height={0}  className="w-screen" src="/intoduction-banner.svg" />} />
      <Seperator />
      <PhoneWebComponent PhoneComponent={<Image priority={true} alt="photo of me"   width={0} height={0} className="w-screen" src="/phone-lift-collage.jpg" />} WebComponent={<Image priority={true} alt="photo of me" className="w-screen"   width={0} height={0}  src="/web-lift-collage.jpg" />}  />
      {/*<Parallax pages = {5}>
